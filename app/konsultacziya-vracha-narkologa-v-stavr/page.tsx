...
<main>
    <div class="container">
                ...
                <header class="entry-header">
                    <h1 class="entry-title">Консультация врача-нарколога в Ставрополе</h1>
                </header>
...
<h1> Консультация нарколога: Первый шаг к новой жизни</h1>
<p>Если вы или ваши близкие столкнулись с проблемой зависимости, не откладывайте решение на потом. Наши опытные наркологи готовы помочь вам справиться с любой формой зависимости и вернуть контроль над своей жизнью. Мы предлагаем профессиональную помощь и поддержку на каждом этапе вашего пути к выздоровлению.</p>
<p>			<a href="tel:+79888641010"><br />
									Позвонить<br />
					</a></p>
<h2>Комплексный подход к лечению зависимости</h2>
<p>Мы предлагаем широкий спектр услуг для людей, страдающих различными видами зависимости:</p>
<p>&#8212; Алкогольная зависимость: Индивидуальные программы лечения и реабилитации<br />&#8212; Наркотическая зависимость: Эффективные методы лечения для молодых людей и взрослых<br />&#8212; Зависимость от лекарственных препаратов: Профессиональная помощь пациентам, ставшим зависимыми от рецептурных лекарств.<br />&#8212; Игровая зависимость: Специальные программы для мужчин и женщин в стремящихся избавиться от зависимости от азартных игр.</p>
<p>			<a><br />
		Записаться на прием<br />
	</a></p>
<h1>Преимущества нашей консультации</h1>
<p>&#8212; Опытные специалисты: Наши наркологи имеют многолетний опыт работы и высокую квалификацию.</p>
<p>&#8212; Индивидуальный подход: Мы разрабатываем персонализированные программы лечения, учитывая особенности каждого пациента.</p>
<p>&#8212; Конфиденциальность: Мы гарантируем полную анонимность и конфиденциальность всех консультаций и процедур.</p>
<p>&#8212; Поддержка 24/7: Наши специалисты всегда готовы оказать помощь и поддержку в любое время суток.</p>
<p>			<a href="tel:+79888641010"><br />
									Позвонить<br />
					</a></p>
...
export const metadata: Metadata = {
  title: "Консультация врача-нарколога в Ставрополе - Медицинский центр Амадея в Ставрополе",
  description: "Консультация врача-нарколога в Ставрополе в клинике «Амадея»: очно и анонимно, обследование и план лечения зависимости. Запись ☎ 8 (988) 864-10-10.",
  alternates: { canonical: "https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/" },
  openGraph: { locale: "ru_RU", type: "website", title: "Консультация врача-нарколога в Ставрополе - Медицинский центр Амадея в Ставрополе", url: "https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/", siteName: "Медицинский центр Амадея в Ставрополе" },
};

export default function KonsultacziyaVrachaNarkologaVStavrPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/","url":"https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/","name":"Консультация врача-нарколога в Ставрополе - Медицинский центр Амадея в Ставрополе","isPartOf":{"@id":"https://amadeya26.ru/#website"},"primaryImageOfPage":{"@id":"https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/#primaryimage"},"image":{"@id":"https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/#primaryimage"},"thumbnailUrl":"https://amadeya26.ru/wp-content/uploads/2024/06/photo_323-1024x1024.webp","datePublished":"2024-07-11T15:48:19+00:00","dateModified":"2025-02-20T18:44:13+00:00","breadcrumb":{"@id":"https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/#breadcrumb"},"inLanguage":"ru-RU","potentialAction":[{"@type":"ReadAction","target":["https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/"]}]},{"@type":"ImageObject","inLanguage":"ru-RU","@id":"https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/#primaryimage","url":"https://amadeya26.ru/wp-content/uploads/2024/06/photo_323.webp","contentUrl":"https://amadeya26.ru/wp-content/uploads/2024/06/photo_323.webp","width":1280,"height":1280},{"@type":"BreadcrumbList","@id":"https://amadeya26.ru/konsultacziya-vracha-narkologa-v-stavr/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная страница","item":"https://amadeya26.ru/"},{"@type":"ListItem","position":2,"name":"Консультация врача-нарколога в Ставрополе"}]},{"@type":"WebSite","@id":"https://amadeya26.ru/#website","url":"https://amadeya26.ru/","name":"Медицинский центр Амадея в Ставрополе","description":"","publisher":{"@id":"https://amadeya26.ru/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://amadeya26.ru/?s={search_term_string}"},"query-input":{"@type":"PropertyValueSpecification","valueRequired":true,"valueName":"search_term_string"}}],"inLanguage":"ru-RU"},{"@type":"Organization","@id":"https://amadeya26.ru/#organization","name":"Медицинский центр Амадея в Ставрополе","url":"https://amadeya26.ru/","logo":{"@type":"ImageObject","inLanguage":"ru-RU","@id":"https://amadeya26.ru/#/schema/logo/image/","url":"https://amadeya26.ru/wp-content/uploads/2022/10/LOGO12.png","contentUrl":"https://amadeya26.ru/wp-content/uploads/2022/10/LOGO12.png","width":68,"height":68,"caption":"Медицинский центр Амадея в Ставрополе"},"image":{"@id":"https://amadeya26.ru/#/schema/logo/image/"}}]}` }} />
