...
<main>
    <div class="container">
                ...
                <header class="entry-header">
                    <h1 class="entry-title">Супервизия при зависимости в Ставрополе</h1>
                </header>
...
<h1> Супервизия при зависимости: Поддержка на пути к выздоровлению</h1>
<p>Супервизия — это поддержка опытного специалиста, который поможет вам справиться с трудностями на пути к выздоровлению, даст советы по преодолению сложных ситуаций и предотвращению срывов.</p>
<p>			<a href="tel:+79888641010"><br />
									Позвонить<br />
					</a></p>
<h2>Комплексная супервизия при зависимости</h2>
<p>&#8212; Персональные сеансы: Индивидуальный подход к каждому пациенту.</p>
<p>&#8212; Групповые встречи: Обмен опытом и поддержка в группе.</p>
<p>&#8212; Когнитивно-поведенческая поддержка: Изменение негативных мыслей и поведения.</p>
<p>&#8212; Обучение навыкам самоконтроля: Техники для управления стрессом и предотвращения рецидивов.</p>
<p>&#8212; Консультации для родственников: Помощь близким в поддержке пациента.</p>
<p>			<a><br />
		Записаться на прием<br />
	</a></p>
<h1>Почему выбирают нас<br />
</h1>
<p>&#8212; Профессионализм и опыт: Наши специалисты имеют многолетний опыт работы с зависимостями.<br />&#8212; Комплексный подход: Индивидуальные и групповые сеансы, обучение навыкам саморегуляции.<br />&#8212; Доступность и удобство: Удобное расписание и возможность онлайн-консультаций.<br />&#8212; Конфиденциальность: Полная анонимность всех консультаций.<br />&#8212; Поддержка на каждом этапе: Сопровождение на всех этапах лечения и реабилитации.</p>
<p>			<a href="tel:+79888641010"><br />
									Позвонить<br />
					</a></p>
<h1>Сделайте первый шаг к свободе от зависимости</h1>
<p> Запишитесь на прием к супервизору прямо сейчас и начните жить полноценной жизнью.</p>
<p>1. Заполните форму записи: Укажите свои контактные данные и удобное время для консультации.<br />2. Получите подтверждение: Наши специалисты свяжутся с вами для подтверждения записи.<br />3. Начните консультацию: В назначенное время приходите на прием и начните путь к выздоровлению.</p>
<p>			<a role="button"><br />
									Записаться<br />
					</a><br />
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/" },
  openGraph: { locale: "ru_RU", type: "website", title: "Супервизия при зависимости в Ставрополе - Медицинский центр Амадея в Ставрополе", url: "https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/", siteName: "Медицинский центр Амадея в Ставрополе" },
};

export default function SuperviziyaPriZavisimostiVStavropPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/","url":"https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/","name":"Супервизия при зависимости в Ставрополе - Медицинский центр Амадея в Ставрополе","isPartOf":{"@id":"https://amadeya26.ru/#website"},"primaryImageOfPage":{"@id":"https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/#primaryimage"},"image":{"@id":"https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/#primaryimage"},"thumbnailUrl":"https://amadeya26.ru/wp-content/uploads/2024/06/photo_323-1024x1024.webp","datePublished":"2024-07-17T17:58:36+00:00","dateModified":"2025-02-20T18:52:09+00:00","breadcrumb":{"@id":"https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/#breadcrumb"},"inLanguage":"ru-RU","potentialAction":[{"@type":"ReadAction","target":["https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/"]}]},{"@type":"ImageObject","inLanguage":"ru-RU","@id":"https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/#primaryimage","url":"https://amadeya26.ru/wp-content/uploads/2024/06/photo_323.webp","contentUrl":"https://amadeya26.ru/wp-content/uploads/2024/06/photo_323.webp","width":1280,"height":1280},{"@type":"BreadcrumbList","@id":"https://amadeya26.ru/superviziya-pri-zavisimosti-v-stavrop/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная страница","item":"https://amadeya26.ru/"},{"@type":"ListItem","position":2,"name":"Супервизия при зависимости в Ставрополе"}]},{"@type":"WebSite","@id":"https://amadeya26.ru/#website","url":"https://amadeya26.ru/","name":"Медицинский центр Амадея в Ставрополе","description":"","publisher":{"@id":"https://amadeya26.ru/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://amadeya26.ru/?s={search_term_string}"},"query-input":{"@type":"PropertyValueSpecification","valueRequired":true,"valueName":"search_term_string"}}],"inLanguage":"ru-RU"},{"@type":"Organization","@id":"https://amadeya26.ru/#organization","name":"Медицинский центр Амадея в Ставрополе","url":"https://amadeya26.ru/","logo":{"@type":"ImageObject","inLanguage":"ru-RU","@id":"https://amadeya26.ru/#/schema/logo/image/","url":"https://amadeya26.ru/wp-content/uploads/2022/10/LOGO12.png","contentUrl":"https://amadeya26.ru/wp-content/uploads/2022/10/LOGO12.png","width":68,"height":68,"caption":"Медицинский центр Амадея в Ставрополе"},"image":{"@id":"https://amadeya26.ru/#/schema/logo/image/"}}]}` }} />
