                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="people-item __line-block-item">
                                <div class="people-item-photo"><img loading="eager" decoding="async" src="/wp-content/themes/amadeya-redesign/assets/img/mutaeva-480.webp" width="480" height="622" alt="Врач Мутаева Ольга Юрьевна"></div>
                        ...
                        <div class="swiper-slide">
                            <div class="people-item __line-block-item">
                                <div class="people-item-photo"><img loading="eager" decoding="async" src="/wp-content/themes/amadeya-redesign/assets/img/kron-480.webp" width="480" height="622" alt="Врач Крон Елена Ивановна"></div>
                                <div class="people-item-desc">
                        ...
                        <div class="swiper-slide">
                            <div class="people-item __line-block-item">
                                <div class="people-item-photo"><img loading="eager" decoding="async" src="/wp-content/themes/amadeya-redesign/assets/img/kamolikova-480.webp" width="480" height="622" alt="Врач Камоликова Жанна Анатольевна"></div>
                                <div class="people-item-desc">
