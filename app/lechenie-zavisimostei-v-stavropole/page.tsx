...
<h2>Комплексное лечение зависимостей</h2>
<p>Мы предлагаем широкий спектр услуг для людей, страдающих различными видами зависимости:</p>
<p>&#8212; Алкогольная зависимость: Индивидуальные программы лечения и реабилитации для мужчин и женщин в возрасте 25-50 лет.<br />&#8212; Наркотическая зависимость: Эффективные методы лечения для молодых людей и взрослых в возрасте 18-40 лет.<br />&#8212; Зависимость от лекарственных препаратов: Профессиональная помощь пациентам, ставшим зависимыми от рецептурных лекарств.<br />&#8212; Игровая зависимость: Специальные программы для мужчин и женщин в возрасте 18-45 лет, стремящихся избавиться от зависимости от азартных игр.<br />&#8212; Поддержка для родственников: Консультации и помощь для родителей и родственников зависимых, чтобы они могли лучше понять и поддержать своих близких.</p>
<p>			<a><br />
		Записаться на прием<br />
	</a></p>
<h1>Преимущества нашего лечения зависимостей</h1>
<p>&#8212;  Опытные специалисты : Наши врачи и психологи имеют многолетний опыт работы и высокую квалификацию.<br />&#8212; Индивидуальный подход: Мы разрабатываем персонализированные программы лечения, учитывая особенности каждого пациента.<br />&#8212; Конфиденциальность: Мы гарантируем полную анонимность и конфиденциальность всех консультаций и процедур.<br />&#8212; Современные методы лечения: Использование передовых методик и технологий для достижения наилучших результатов.<br />&#8212; Поддержка 24/7: Наши специалисты всегда готовы оказать помощь и поддержку в любое время суток.</p>
<p>			<a href="tel:+79888641010"><br />
									Позвонить<br />
					</a></p>
...
export const metadata: Metadata = {
  ...
  description: "Лечение зависимостей в Ставрополе в клинике «Амадея»: алкогольная, наркотическая зависимость, реабилитация, анонимно и под контролем врачей. Запись ☎ 8 (988) 864-10-10.",
